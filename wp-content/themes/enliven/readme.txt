...
* Image used for default header image.
	Image Link - https://pixabay.com/en/stage-crowd-fans-live-concert-1531427/
	Image License - https://creativecommons.org/publicdomain/zero/1.0/deed.en
...
- Version 1.1.4
Fixed a small issue in Testimonial image header.
Fixed some styiling issues in business homepage widgets.
Removed footer copyright default text from customizer.

- Version 1.1.5
Fixed css issues in client widget and featured pages widget.
Changed site title and navigation width.
Fixed mobile navigation.

- Version 1.1.6
Added pagination function enliven_paging_nav for Portfolio page template.

- Version 1.1.7
Added custom header feature. ( custom-header.php )
Added new function enliven_header_background.
Updated translation files.
Updated font awesome version.
Updated theme filtering tags.

- Version 1.1.8
Added editor-style.css.
Added color control to change the main theme color.
Added color controls to change button colors.
...
- Version 1.2.0
Added few stylings to default wordpress widgets to display on static frontpage.
Fixed a wrong text in customizer color section.
Updated translation file.